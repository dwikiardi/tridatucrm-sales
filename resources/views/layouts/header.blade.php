                ...
                <ul class="navbar-nav menuheader">
                  ...
                  <li class="nav-item dropdown activity">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="{{ url('coa') }}" >
                        Cart of Account
                      </a> 
                      <hr style="padding:0!important;margin:0!important">
                      <a class="dropdown-item" href="{{ url('bills') }}" >
                        Bill's 
                      </a>
                      ...
                      <hr style="padding:0!important;margin:0!important">
                      <a class="dropdown-item" href="{{url('generalladger')}}" >
                        General Ladger
                      </a>
                      <a class="dropdown-item" href="{{url('ar')}}" >
                        Accounts Receivable
                      </a>
                      <a class="dropdown-item" href="{{url('ap')}}" >
                        Accounts Payable
                      </a>
                      <hr style="padding:0!important;margin:0!important">
                      <a class="dropdown-item" href="{{url('accreport')}}" >
                        Accounting Reports
                      </a>
                    </div>
                  </li>
                  ...
                  <a class="nav-link dropdown-toggle" href="#navbar-layout" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                    ...
                    <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="{{url('departement')}}" >
                          Departemen
                          </a>
                    </div>
                  </li>
