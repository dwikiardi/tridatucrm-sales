            ...
            <div class="tab-pane fade active show" id="tabs-home-17">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header ">
                          ...
                          <div class="col-auto ms-auto d-print-none"> 
                            <a href="{{ url('contacts/create')}}/{{$accounts[0]->id}}" class="btn btn-primary d-none d-sm-inline-block" > New </a>   
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body rowcollapse multi-collapse show" id="multiCollapseExample2">
                    <div class="table-responsive" >
                      <table class="table card-table table-vcenter text-nowrap property">
                        <thead>
                          <tr>
                            <th>Name</th>
                            <th>Address</th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.property').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{route('accounts.property',$accounts[0]->id)  }}",
        columns: [
            {data: 'Name', "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) 
              {
            ...
            {data: 'Contacts', "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) 
              {
                $(nTd).html("<a href='{{ url('contacts/view')}}/"+oData.CID+"'>"+oData.Contacts+"</a>");
              }
            },
            {data: 'Accounts', "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) 
              {
                $(nTd).html("<a href='{{ url('accounts/view')}}/"+oData.AID+"'>"+oData.Accounts+"</a>");
              }
            },
