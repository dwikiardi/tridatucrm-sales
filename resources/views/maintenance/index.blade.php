      ...
      <div class="row align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none"> 
          <div class="btn-list">
            ...
            <a href="{{ url('maintenance/create')}}" class="btn btn-primary d-none d-sm-inline-block">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.datatable').DataTable({
        ...
        columns: [
          {data: 'NoMaintenance', "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) 
              {
                $(nTd).html(oData.NoMaintenance);
              }
            },
            ...
            {data: 'MaintenanceBy', "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) 
              {
                $(nTd).html(oData.MaintenanceBy);
              }
            },
    ...
    $(document).on("click",".printjo",function(){
      ...
      $.ajax({
        url: "{{url('maintenance/printjo')}}/" + id ,
        type: "GET",
        data: id,
    ...
    $(document).on("click",".prininstal",function(){
      ...
      $.ajax({
        url: "{{url('maintenance/installed')}}/" + id ,
        type: "GET",
        data: id,
        success: function( response ) {
          const obj = JSON.parse(response);
