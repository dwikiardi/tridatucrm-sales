...
<head>
  ...
  <title>Maintenance Job Order</title>
</head>
<body>
    ...
    <tr>
      <td width="40%">
        ...
        <tr>
            ...
            <td width="10%">:</td>
            <td width="30%">{{$maintenance[0]->contact}}</td>
          </tr>
          <tr>
      ...
      <td colspan=3>
        ...
        <table class="body_table " style="margin-bottom: 10px;width:100%;">
          ...
          <tr>
            ...
            <td style=" border: solid 1px #000;">{{$pdf->qty}} {{$pdf->unit}}</td>
          </tr>
          @if($pdf->type==1)
          <tr>
